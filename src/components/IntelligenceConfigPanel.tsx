        ...
        <div className="mb-5 pb-4 border-b border-neutral-100">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-neutral-900">
              {showExpertMode ? '세부 수집 파라미터 직접 설정' : 'DevRel 목적별 추천 템플릿'}
            </h2>
          </div>
                  ...
                  <div className="bg-white p-3.5 rounded-xl border border-neutral-200 space-y-2">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1 rounded-md bg-neutral-100 border border-neutral-200 text-neutral-700 hover:bg-neutral-200 hover:text-neutral-900 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shrink-0"
                        title="1일 감소"
                      >
                      ...
                      <input
                        ...
                        max="90"
                        step="1"
                        value={getDaysFromPeriod(period)}
                        onChange={(e) => {
