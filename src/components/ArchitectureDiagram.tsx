...
const STEPS: StepDetail[] = [
  {
    ...
    description: "국내외 주요 엔지니어링 블로그, 개발자 커뮤니티, 기술 공유 자료에서 최신 아티클과 지식 시그널을 수집합니다.",
    details: [
      "국내외 테크 블로그 (네카라쿠배당토, Google, Netflix 등) 스캐닝",
      "기술 커뮤니티 (GeekNews, Hacker News, Velog) 핫 토픽 추출",
      "마크다운 본문 파싱 및 키워드·카테고리 분류"
    ],
    sources: ["국내 대표 테크 블로그 (네카라쿠배당토)", "글로벌 빅테크 엔지니어링 블로그", "개발자 커뮤니티 & 뉴스"],
    color: "#2563eb"
  },
  {
    id: 2,
    title: "단계 02: DevRel 큐레이션 & 팩트체크",
    description: "수집된 지식 아티클을 구글 서치 그라운딩으로 팩트 검증하고, DevRel 실무 가치(교육, 채용 브랜딩, 기술 공유)를 스코어링합니다.",
    details: [
      "Google Search Grounding 기반 독립 원문 상호 교차 검증 (환각 필터링)",
      "DevRel 실무 기여도 (기술 영향도, 사내 세션 재활용성, 채용 브랜딩) 평가",
      "유사 엔지니어링 주제 클러스터링 및 노이즈 제거"
    ],
    color: "#059669"
  },
  {
    id: 3,
    title: "단계 03: 지식 자산화 & 파이프라인 연동",
    description: "분석 결과를 기반으로 테크블로그 기획안, 아티클 제목, 브리프 리포트를 자동 생성하고 노션 DB에 동기화합니다.",
    details: [
      "테크블로그 & 사내 교육 세션 기획안 도출",
      "개발자 오디언스 타겟팅 및 헤드라인 카피 제안",
      "웹 대시보드 리포트 구성 및 노션 DB / n8n 자동 연동"
    ],
    outputs: ["DevRel 액션 대시보드 리포트", "Notion DB 자동 동기화 & n8n 파이프라인"],
    color: "#111111"
  }
];
          ...
          <div className="bg-white p-6 sm:p-7 rounded-2xl border border-neutral-200 shadow-xs flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-neutral-600 text-xs sm:text-sm font-normal leading-relaxed">
                테크 블로그와 커뮤니티의 기술 지식을 수집·검증하여 사내 지식 공유와 개발 조직 브랜딩을 효율화합니다.
              </p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl p-6 md:p-10 border border-neutral-200 relative overflow-hidden shadow-xs">
        ...
        <div className="hidden md:block w-full">
          <svg viewBox="0 0 800 560" className="w-full h-auto mx-auto" xmlns="http://www.w3.org/2000/svg">
            ...
            >
              ...
              <text x="400" y="153" fontFamily="sans-serif" fontSize="11" fontWeight="500" fill="#64748b" textAnchor="middle">국내외 테크 블로그 및 커뮤니티 지식 아티클 수집</text>
            ...
            >
              ...
              <text x="400" y="250" fontFamily="sans-serif" fontSize="14" fontWeight="700" fill="#ffffff" textAnchor="middle">단계 02: DevRel 큐레이션 &amp; 팩트체크</text>
              <text x="400" y="273" fontFamily="sans-serif" fontSize="11" fontWeight="500" fill="#94a3b8" textAnchor="middle">Google Search Grounding 기반 환각 0% 원문 교차 검증</text>
              <text x="400" y="291" fontFamily="sans-serif" fontSize="11" fontWeight="500" fill="#94a3b8" textAnchor="middle">실무 가치 (사내 교육 / 채용 브랜딩 / 기술 임팩트) 스코어링</text>
            ...
            >
              ...
              <text x="400" y="370" fontFamily="sans-serif" fontSize="14" fontWeight="700" fill="#1e293b" textAnchor="middle">단계 03: 지식 자산화 &amp; 액션 브리프 생성</text>
              <text x="400" y="393" fontFamily="sans-serif" fontSize="11" fontWeight="500" fill="#64748b" textAnchor="middle">테크블로그 / 세션 기획안 &amp; 썸네일 헤드라인 카피 도출</text>
              <text x="400" y="411" fontFamily="sans-serif" fontSize="11" fontWeight="500" fill="#64748b" textAnchor="middle">웹 대시보드 리포트 생성 및 노션 DB 파이프라인 매핑</text>
            ...
            <g className="transition-opacity duration-150 hover:opacity-90">
              ...
              <text x="400" y="493" fontFamily="sans-serif" fontSize="13" fontWeight="700" fill="#ffffff" textAnchor="middle">Notion DB &amp; n8n 파이프라인 자동 동기화</text>
            </g>
          </svg>
        </div>
        ...
        <div className="block md:hidden w-full space-y-3">
          ...
          <div className="bg-neutral-900 text-white p-4 rounded-xl text-center">
            ...
            <h4 className="text-xs font-bold">Notion DB &amp; n8n 파이프라인 자동 동기화</h4>
          </div>
        </div>
      </div>
